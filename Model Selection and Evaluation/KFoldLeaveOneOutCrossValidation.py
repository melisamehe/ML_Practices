...
print("KF En iyi sonuc:", tree_grid_search.best_params_)
print("KF En iyi acc:", tree_grid_search.best_score_)
...
print("LOO En iyi sonuc:", tree_grid_search_loo.best_params_)
