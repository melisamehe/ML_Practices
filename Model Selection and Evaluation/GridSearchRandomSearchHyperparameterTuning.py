...
tree_random_search = RandomizedSearchCV(tree, tree_param_grid, n_iter=1)
...
print("DT Grid Search Best Parameters: ",svm_grid_search.best_params_)
print("DT Grid Search Best Accuracy: ",svm_grid_search.best_score_)


svm_random_search = RandomizedSearchCV(svm, svm_param_grid, n_iter=1)
